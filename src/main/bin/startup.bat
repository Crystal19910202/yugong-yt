...
set JAVA_OPTS= -Djava.awt.headless=true -Djava.net.preferIPv4Stack=true -Dapplication.codeset=UTF-8 -Dfile.encoding=UTF-8 -Xms1024m -Xmx4096m -XX:PermSize=1024m -XX:+HeapDumpOnOutOfMemoryError -DappName=yugong -Dlogback.configurationFile="%logback_configurationFile%" -Dyugong.conf="%yugong_conf%"
